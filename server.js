...
// ==========================================================
// ENDPOINT PARA ENVIAR NOTIFICACIONES PUSH (ONESIGNAL v16 con alias)
// ==========================================================
app.post('/api/send-notification', async (req, res) => {
  ...
  try {
    const bodyPayload = {
      ...
      // APUNTAR POR ALIAS (recomendado en v16)
      include_aliases: {
        external_id: [locutorId.trim()]
      }
      // Si quisieras filtrar por tag en vez de alias (menos robusto):
    ...
    // DEVOLVEMOS LA RESPUESTA REAL (incluye "recipients")
